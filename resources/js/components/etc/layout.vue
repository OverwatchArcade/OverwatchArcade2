        ...
        <section id="footer" class="mt-4">
            <div class="row">
                <div class="col-12 col-md-9">
                    ...
                    <p class="small">{{$t('footer.copyright_materials')}}</p>
                    <p class="small">{{$t('footer.copyright_site')}} <a rel="license" target="_blank"
                                                                        href="https://creativecommons.org/licenses/by-nc-sa/4.0/">Creative
                        Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>
                        <br/>
                        {{$t('footer.made_by')}} <a target="_blank" href="//bluedog.dev">bluedog</a>  {{$t('footer.contributors')}} <router-link to="/contributors">contributors</router-link>
                    </p>
